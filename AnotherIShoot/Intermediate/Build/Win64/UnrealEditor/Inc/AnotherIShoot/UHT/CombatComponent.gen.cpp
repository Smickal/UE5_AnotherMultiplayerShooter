...
// Begin Class UCombatComponent Function OnRep_bCarryingFlag
struct Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "BlasterComponent/CombatComponent.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCombatComponent, nullptr, "OnRep_bCarryingFlag", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCombatComponent::execOnRep_bCarryingFlag)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnRep_bCarryingFlag();
	P_NATIVE_END;
}
// End Class UCombatComponent Function OnRep_bCarryingFlag
...
// Begin Class UCombatComponent Function OnRep_Flag
struct Z_Construct_UFunction_UCombatComponent_OnRep_Flag_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "BlasterComponent/CombatComponent.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatComponent_OnRep_Flag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCombatComponent, nullptr, "OnRep_Flag", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatComponent_OnRep_Flag_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatComponent_OnRep_Flag_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UCombatComponent_OnRep_Flag()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCombatComponent_OnRep_Flag_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCombatComponent::execOnRep_Flag)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnRep_Flag();
...
// End Class UCombatComponent Function OnRep_Flag
...
void UCombatComponent::StaticRegisterNativesUCombatComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "OnRep_bCarryingFlag", &UCombatComponent::execOnRep_bCarryingFlag },
		...
		{ "OnRep_Flag", &UCombatComponent::execOnRep_Flag },
...
struct Z_Construct_UClass_UCombatComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsCarryingAFlag_MetaData[] = {
		{ "ModuleRelativePath", "BlasterComponent/CombatComponent.h" },
	};
#endif // WITH_METADATA
	...
	static void NewProp_bIsCarryingAFlag_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsCarryingAFlag;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCombatComponent_OnRep_bCarryingFlag, "OnRep_bCarryingFlag" }, // 3346243389
		...
		{ &Z_Construct_UFunction_UCombatComponent_OnRep_Flag, "OnRep_Flag" }, // 2525299260
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_EquippedWeapon = { "EquippedWeapon", "OnRep_EquippedWeapon", (EPropertyFlags)0x0040000100000034, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombatComponent, EquippedWeapon), Z_Construct_UClass_AWeapon_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EquippedWeapon_MetaData), NewProp_EquippedWeapon_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_Flag = { "Flag", "OnRep_Flag", (EPropertyFlags)0x0040000100000020, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombatComponent, Flag), Z_Construct_UClass_AWeapon_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Flag_MetaData), NewProp_Flag_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsAiming = { "bIsAiming", "OnRep_Aiming", (EPropertyFlags)0x0040000100000034, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCombatComponent), &Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsAiming_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsAiming_MetaData), NewProp_bIsAiming_MetaData) };
...
void Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsCarryingAFlag_SetBit(void* Obj)
{
	((UCombatComponent*)Obj)->bIsCarryingAFlag = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsCarryingAFlag = { "bIsCarryingAFlag", "OnRep_bCarryingFlag", (EPropertyFlags)0x0040000100000020, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCombatComponent), &Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsCarryingAFlag_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsCarryingAFlag_MetaData), NewProp_bIsCarryingAFlag_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCombatComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCombatComponent_Statics::NewProp_Flag,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCombatComponent_Statics::NewProp_bIsCarryingAFlag,
};
...
void UCombatComponent::ValidateGeneratedRepEnums(const TArray<struct FRepRecord>& ClassReps) const
{
	...
	static const FName Name_Flag(TEXT("Flag"));
	...
	static const FName Name_bIsCarryingAFlag(TEXT("bIsCarryingAFlag"));
	const bool bIsValid = true
		...
		&& Name_Flag == ClassReps[(int32)ENetFields_Private::Flag].Property->GetFName()
		...
		&& Name_bIsCarryingAFlag == ClassReps[(int32)ENetFields_Private::bIsCarryingAFlag].Property->GetFName();
...
struct Z_CompiledInDeferFile_FID_Unreal_Projects_Third_Person_Shooter_UE5_AnotherMultiplayerShooter_AnotherIShoot_Source_AnotherIShoot_BlasterComponent_CombatComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCombatComponent, UCombatComponent::StaticClass, TEXT("UCombatComponent"), &Z_Registration_Info_UClass_UCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatComponent), 2905536515U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Third_Person_Shooter_UE5_AnotherMultiplayerShooter_AnotherIShoot_Source_AnotherIShoot_BlasterComponent_CombatComponent_h_2450298396(TEXT("/Script/AnotherIShoot"),
